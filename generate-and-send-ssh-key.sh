...
# Copy the key to the Windows path
echo
echo "Copying the key to the Windows path C:\\Users\\joes\\.ssh"
cp ${FILENAME} /mnt/c/Users/joes/.ssh/id_rsa
cp ${FILENAME}.pub /mnt/c/Users/joes/.ssh/id_rsa.pub

echo "Key has been copied to C:\\Users\\joes\\.ssh"
